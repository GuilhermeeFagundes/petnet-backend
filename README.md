...
2.  **[MySQL](https://dev.mysql.com/downloads/installer/)** (Rodando na porta 3306)
...
```bash
git clone [https://github.com/SEU-USUARIO/petnet-backend.git](https://github.com/SEU-USUARIO/petnet-backend.git)
cd petnet-backend
